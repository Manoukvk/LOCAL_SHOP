...
product1 = Product.create(name: "Trb Short", description: "Dead stock grey hand printed in black tribals Short", price_cents: 35, color: "Grey", size:"S/M/L", designer: designer1, category: women_short)
...
product2 = Product.create(name: "Tie Dyed Pants", description: "Dead stock cotton jersey black hand dyed with elastic waist.", price_cents: 45, color: "Black", size: "One size", designer: designer1, category: women_pants)
...
product3 = Product.create(name: "Top Thorns Beige", description: "Dead stock printed mesh top.", price_cents: 25, color: "Yellow", size: "S/M", designer: designer1, category: women_tshirt)
...
product4 = Product.create(name: "Dress Antila", description: "See-through dress made of Organza curtains. Perfect with a shirt, blouse or jumpsuit underneath. Dead-stock made piece.", price_cents: 70, color: "Orange", size: "One size", designer: designer1, category: women_dress)
...
product5 = Product.create(name: "Top Crux", description: "Stand-up collar top made of jersey, with dragon tribals handmade printed. ", price_cents: 35, color: "Purple", size: "S", designer: designer1, category: women_tshirt)
...
product6 = Product.create(name: "MARIPOSA", description: "Mariposa necklace from the Fantasy Collection, made of biodegradable Material, 4 cm.", price_cents: 25, color: "White", size: "One size", designer: designer2, category: unisex_necklace)
...
product7 = Product.create(name: "DRAGON", description: "DRAGON earrings from the Fantasy Collection, 10 cm.", price_cents: 36, color: "Green", size: "One size", designer: designer2, category: unisex_earings)
...
product8 = Product.create(name: "Stinger", description: "Cute Stinger earrings Fantasy Collection, 4,5 cm.", price_cents: 35, color: "White", size: "One size", designer: designer2, category: unisex_earings)
...
product9 = Product.create(name: "Chain", description: "Chain Collection Choker", price_cents: 50, color: "Yellow", size: "One size", designer: designer2, category: unisex_necklace)
...
product10 = Product.create(name: "Corazón", description: "CORAZÓN Choker Fantasy Collection Choker", price_cents: 30, color: "Pink", size: "One size", designer: designer2, category: unisex_necklace )
...
product11 = Product.create(name: "Assam Jacket Yellow", description: "Canvas  structure with a smooth surface.", price_cents: 110, color: "Yellow", size: "S/M/L", designer: designer3, category: man_jacket)
...
product12 = Product.create(name: "Wakame Shirt Lemon On Ice", description: "Short sleeve shirt with spread collar.", price_cents: 70, color: "Blue", size: "S/M/L", designer: designer3, category: man_shirt)
...
product13 = Product.create(name: "Khaya Jacket Orange/Olive", description: "Reversible Jacket.", price_cents: 150, color: "Green", size: "S/M/L", designer: designer3, category: man_jacket )
...
product14 = Product.create(name: "Wakame Shirt Birds", description: "Short sleeve shirt with spread collar.", price_cents: 85, color: "Purple ", size: "S/M/L", designer: designer3, category: man_shirt)
...
product15 = Product.create(name: "Yucca Shirt White Brown Green", description: "Shirt with band collar.", price_cents: 85, color: "Brown", size: "S/M/L", designer: designer3, category: man_shirt)
...
product16 = Product.create(name: "FANA DRESS Sheer Tan Linen", description: "The Fana dress has a 3/4 length and a scoop neck. It is crafted from sheer tan linen and has side slits. ", price_cents: 99, color: "Bege", size: "XS/S", designer: designer4, category: women_dress)
...
product19 = Product.create(name: "GESA PANTS Summer Wool Check", description: "Our cropped Gesa Pants are made with a wide leg, front pleat, and 3/4 legs. This version is crafted from durable light-weight summer wool.", price_cents: "100", color: "Brown", size: 40, designer: designer4, category: women_pants)
...
product20 = Product.create(name: "SONDE TOP Striped Linen", description: "Our sleeveless Sonde Top has a soft fall, pearl button-up front, and blouse collar with double segmented back detail which can be worn open or closed with hidden buttons depending on how much wind you desire. This version is made from unique natural striped linen.", price_cents: 79, color: "White", size: "M/L", designer: designer4, category: women_shirt)
...
product21 = Product.create(name: "Biker Suzuka", description: "Bike short patterned prints with handmade drawings.", price_cents: 25, color: "Black", size: "S/M/L", designer: designer5, category: women_short )
...
product22 = Product.create(name: "T-shir Fijjji", description: "Patterned prints handmade by the designer.", price_cents: 50, color: "Black", size: "S/M/L", designer: designer5, category: women_tshirt)
...
product23 = Product.create(name: "Jacket yuuki reversable", description: "Reverible Jacket.", price_cents: 150, color: "Yellow", size: "S/M/L", designer: designer5, category: women_jacket)
...
product24 = Product.create(name: "Pants Hanami", description: "Handmade embroidered trousers.", price_cents: 180, color: "Black", size: "S/M/L", designer: designer5, category: women_pants)
...
product25 = Product.create(name: "QUILT BOMBER JACKET - reversible", description: "Hand-quilted Bomber jacket, reversible with pockets on one side and press studs. This garment is made to order.", price_cents: 350, color: "Blue", size: "S/M", designer: designer6, category: women_jacket)
...
product26 = Product.create(name: "QUILT JUMPER - reversible", description: "Handquilted Jumper, reversible and variable with press studs on the left sleeve.", price_cents: 200, color: "Yellow", size: "S/M/L", designer: designer6, category: women_jacket)
...
product27 = Product.create(name: "SHIRT 02 with Quilt Collar", description: "White Shirt with banded Quilt Collar, button-down front and two different pockets.", price_cents: 120, color: "White", size: "S/M/L", designer: designer6, category: women_shirt)
...
product28 = Product.create(name: "BUKI AKOMOLAFE x LIVING BLUE_ KHADI PANTS", description: "Pants with pockets and elastic waistband 100% organic cotton.", price_cents: 170, color: "Blue", size: "S/M/L", designer: designer6, category: women_pants)
...
product29 = Product.create(name: "Shirt Ground Control", description: "Shirt unisex printed.", price_cents: 50, color: "White", size: "S/M/L", designer: designer7, category: man_tshirt)
...
product30 = Product.create(name: "Coat Misfit", description: "Coat unisex printed.", price_cents: 60, color: "Black", size: "S/M/L", designer: designer7, category: man_coat)
...
product31 = Product.create(name: "Blazer Smoke", description: "Blazer Smoke unisex.", price_cents: 70, color: "White", size: "S/M/L", designer: designer7, category: man_blazer)
...
product32 = Product.create(name: "Sparkle Butt Pants", description: "Reworked trousers, Stretch.", price_cents: 69, color: "Brown", size: "One size", designer: designer8, category: women_pants)
...
product33 = Product.create(name: "Levitation Skirt", description: "Upcycled suit scraps; Adjustable belt/waist, buckle closure; Wrap skirt, velcro closure-", price_cents: 39, color: "black", size: "One size", designer: designer8, category: women_skirt)
...
product34 = Product.create(name: "Corset Blouse", description: "Reworked blouse, Zipper closure.", price_cents: 139, color: "Blue", size: "One size", designer: designer8, category: women_shirt)
...
product35 = Product.create(name: "Pick-Pocket Pants", description: "Upcycled with all the pockets we took off when reworking shirts, Reclaimed.", price_cents: 109, color: "Blue", size: "One size", designer: designer8, category: women_pants)
...
product36 = Product.create(name: "Cut Out Jacket", description: "Reworked suit jacket; Three buckle closure; Adjustable cotton side straps.", price_cents: 89, color: "White", size: "One size", designer: designer8, category: women_jacket)
...
product37 = Product.create(name: "Phi Dress", description: "We introduce you our lovely oversize turtle neck dress.", price_cents: 120, color: "Black", size: "S/M/L", designer: designer9, category: women_dress)
...
product38 = Product.create(name: "Ida Skirt", description: "This A Line Skirt with asymmetrical length has a zipper on the back and hidden pockets on the seam side.", price_cents: 49, color: "blue", size: "S/M/L", designer: designer9, category: women_skirt)
...
product39 = Product.create(name: "Knight Dress", description: "We introduce you our basic Knight long Dress.", price_cents: 120, color: "Black", size: "S/M/L", designer: designer9, category: women_dress)
...
product40 = Product.create(name: "Cadaqués Dress", description: "We introduce you our basic Cadaqués Dress", price_cents: 120, color: "Blue", size: "S/M/L", designer: designer9, category: women_dress)
...
product41 = Product.create(name: "Emmi Pants Denim", description: "Denim trousers with creases.", price_cents: 100, color: "Black", size: "S/M/L", designer: designer9, category: women_pants)
